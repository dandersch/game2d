...
set COMMON_LINKER_FLAGS=%COMMON_LINKER_FLAGS% dep\win32\SDL2main.lib dep\win32\SDL2.lib shell32.lib /SUBSYSTEM:CONSOLE
...
REM cl.exe %COMMON_COMPILER_FLAGS% -I dep\sdl_image_inc\ src\platform_sdl.cpp /link %COMMON_LINKER_FLAGS% /OUT:bin\megastruct_sdl.exe
